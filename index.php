            ...
            <?php
                ...
                foreach ($result as $row) {
                    ...
                    <div class="col-md-4">
                        <div class="item">
                            <div class="photo">
                                <img src="assets/uploads/<?php echo $row['photo']; ?>" alt="<?php echo $row['title']; ?>" style="max-width: 200px; height: auto;">
                            </div>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <h4>
                                    <?php echo formatMoneyVND($row['p_current_price']); ?> 
                                    <?php if($row['p_old_price'] != ''): ?>
                                    <del>
                                        $<?php echo formatMoneyVND($row['p_old_price']); ?>
                                    </del>
                                    <?php endif; ?>
                                </h4>
                                <div class="rating">
