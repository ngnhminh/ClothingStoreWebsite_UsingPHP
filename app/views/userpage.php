    ...
    <main>
        <main class="infoproduct_container">
            ...
            <div class="infoproduct-content">
                ...
                <aside class="user-info-box">
                    <h3>Thông tin</h3>
                    <p><strong>Người dùng:</strong> <span id="user-name"></span></p>
                    <p><strong>Tên người dùng:</strong> <span id="user-fullname"></span></p>
                    <p><strong>Mật khẩu:</strong> <span id="user-password">****</span>
        ...
        <script>
            ...
            function loadUserInfo() {
                ...
                document.getElementById("user-fullname").innerText = user.hoten || "Chưa có tên";
                document.getElementById("user-password").innerText = "*".repeat(user.matkhau?.length || 4); // Mặc định là dấu sao
                document.getElementById("toggle-password").innerText = "Hiện";
                document.getElementById("user-phone").innerText = user.sdt || "Chưa có số điện thoại";
                document.getElementById("user-email").innerText = user.email || "Chưa có email";
                document.getElementById("user-points").innerText = user.diemtichluy || 0;
            }
